...
lower.ratings <- data_frame(Variable = c("Democracy", 
                                         ...
                                         "TIP NGO count",
                                         "TIP funding"),
                            Descriptive = c("Countries with better civil liberties are more likely to criminalize, and descriptively, receiving a lower tier rating (watchlist or tier 3) appears to change this probability somewhat. Assigning a lower rating to countries scoring a 1 in the Freedom House score does little to affect the probability of criminalization, but for worse values of civil liberties, countries with lower ratings are more likely to criminalize (see [figure](#descriptive-9)).",
                                            "Descriptively, the relationship between NGO engagement, lower tier ratings, and TIP criminalization appears tenuous. The probability of criminalization increases slightly as NGOs are more engaged, but there is little apparent difference in probability in cases with lower tier ratings (see [figure](#descriptive-10)).",
                                            "In general, increased media coverage of TIP issues increases the probability of criminalization, but that effect is uneven in cases with lower TIP ratings. At some levels of media coverage, cases with lower ratings are more likely to criminalize, but at others, cases with higher ratings have a higher probability of criminalization. There appears to be no interactive effect between the two variables (see [figure](#descriptive-11)).",
                                            "Descriptively, it is difficult to determine the relationship between US aid, lower tier ratings, and criminalization. At extreme levels of aid, countries with higher tier ratings are more likely to criminalize, but that trend reverses with average amounts of aid, where cases with lower ratings are more likely to criminalize (see [figure](#descriptive-12)).",
                                            "Descriptively, there is no apparent relationship between trade and criminalization (except in outlier cases of high amounts of trade), and TIP rating has little effect on the probability of criminalization at any level of trade (see [figure](#descriptive-13)).",
                                            "Descriptively, assignment to a lower rating appears to have a strong effect on the likelihood of criminalization when combined with ratifying the 2000 UN anti-TIP protocol. Cases that had not ratified the protocol *and* received low ratings were the least likely to criminalize, while cases that had ratified *and* received low ratings were the most likely (see [figure](#descriptive-14)).",
                                            "Increased US engagement in anti-TIP discussion initially appears to have a more powerful effect on the likelihood of criminalization in cases where countries have worse tier ratings (see [figure](#descriptive-15)).",
                                            "Descriptively, there appears to be an inverse relationship between the number of anti-TIP NGOs, lower tier ratings, and the probability of criminalization. In cases with higher tier ratings, the likelihood of criminalization increases with more NGOs. However, in cases with lower tier ratings, that likelihood peaks when there are 10–15 NGOs and decreases dramatically with more NGOs—additional NGOs in countries with low ratings do little to improve the chance of criminalization (see [figure](#descriptive-16)).",
                                            "Descriptively, cases with low amounts of anti-TIP funding from the US *and* high tier ratings are more likely to criminalize. As funding increases, though, countries with low tier ratings criminalize far more often(see [figure](#descriptive-17))."),
                            Interactions = c(paste0("Statistically, however, this interactive effect is insignificant. Having worse democracy reduces the likelihood of criminalization by nearly 30% (", parens(model.dem.int.rating, "fh_cl1", "z"), "), and assignment to a lower tier offsets that by increasing the probability by nearly 4 times (", parens(model.dem.int.rating, "low_tier1", "z"), "). The interaction between the two is positive, but not significant (", parens(model.dem.int.rating, "fh_cl1:low_tier1", "z"), "). The [figure showing predicted probabilities](#interactions-visualized-9) confirms this, showing two parallel curves decreasing as civil liberties worsen."),
                                             paste0("This findings hold up statistically. Assignment to a low tier is powerful predictor of criminalization (", parens(model.ngo.int.rating, "low_tier1", "z"), "), while NGO engagement is positively—but insignificantly—correlated with criminalization (", parens(model.ngo.int.rating, "ngos_ave", "z"), "). The interaction between the two is insignificant and negative (", parens(model.ngo.int.rating, "ngos_ave:low_tier1", "z"), "). The [figure of predicted probabilities](#interactions-visualized-10) confirms this."),
                                             paste0("Statistical models, however, do find a significant interactive effect. More media coverage has a tiny (yet significant) positive effect, increasing the probability of criminalization by 0.5% (", parens(model.media.int.rating, "ht_news_country1", "z"), "), and receiving a lower tier boosts that probably more than 6 times (", parens(model.media.int.rating, "low_tier1", "z"), "). The interaction between the two is significant and negative (", parens(model.media.int.rating, "ht_news_country1:low_tier1", "z"), "), but is difficult to interpret. The [figure of predicted probabilities](#interactions-visualized-11) clearly demonstrates this interactive effect—combined with increased media coverage, receiving a lower rating does little to change the chance of criminalization, but cases with high media coverage *and* a higher TIP rating are far more likely to criminalize."),
                                             paste0("Statistical models confirm this lack of relationship. Assignment to a lower tier has an insignificant positive effect on criminalization (", parens(model.aid.int.rating, "low_tier1", "z"), "), while logged aid (", parens(model.aid.int.rating, "logeconasstP_1", "z"), ") and the interaction of aid and lower ratings (", parens(model.aid.int.rating, "logeconasstP_1:low_tier1", "z"), ") have no explanatory power. The [figure of predicted probabilities](#interactions-visualized-12) confirms this further."),
                                             paste0("Again, statistical models confirm this finding. Assignment to the lowest tier boosts the likelihood of criminalization by more than three times (", parens(model.trade.int.rating, "low_tier1", "z"), "), but trade (", parens(model.trade.int.rating, "newus_tradeshare_gdp", "z"), ") and the interaction of trade and tier assignment (", parens(model.trade.int.rating, "newus_tradeshare_gdp:low_tier1", "z"), ") do nothing in the model. The [figure](#interactions-visualized-13) confirms this, showing a slight divergence in probabilities as trade increases."),
                                             paste0("This finding does not hold up well statistically, though. Receiving a low rating again boosts the probability of criminalization by more than three times (", parens(model.rat.int.rating, "low_tier1", "z"), "), but both ratification (", parens(model.rat.int.rating, "ratproto2000_1", "z"), ") and the interaction (", parens(model.rat.int.rating, "low_tier1:ratproto2000_1", "z"), ") are positive and insignificant.  Looking at [predicted probabilities](#interactions-visualized-14) from the model reveals additional insight—lower ratings appear to increase the probability of criminalization more as countries ratify the TIP protocol, but the confidence intervals are too wide to have significance."),
...
downgrading <- data_frame(Variable = c("Democracy", 
                                       ...
                                       "TIP NGO count",
                                       "TIP funding"),
                          Descriptive = c("Receiving a demotion in TIP rating has different effects on criminalization at different levels of democracy. In the first year after a demotion, countries with better civil liberties are generally more likely to criminalize, while worse democracies are less likely to do so. However, by the third year after a demotion, that trend reverses, with worse democracies becoming more likely to criminalize (see [figure](#descriptive-18)).",
                                          "Descriptively, there is no clear relationship between demotion, NGO engagement and criminalization. The probability of criminalization does not increase with more NGO engagement, and the time since demotion does not consistently interact with more engagement (see [figure](#descriptive-19)).",
                                          "In the third year after demotion, cases where media coverage is low are more likely to criminalize TIP, while cases with high media coverage are more likely to criminalize in the first year after demotion. Much of this effect is likely driven by outliers, though (see [figure](#descriptive-20)).",
                                          ...
                                          "Descriptively, cases that have ratified the 2000 UN anti-TIP protocol are far more likely to criminalize TIP, regardless of tier rating demotion. Countries that have ratified the protocol are the most likely to criminalize three years after a demotion, while countries that have not ratified the protocol are more likely to criminalize two years after a demotion. It thus appears that time since demotion has some interactive effect on the likelihood of criminalization (see [figure](#descriptive-23)).",
