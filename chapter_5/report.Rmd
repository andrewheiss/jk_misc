...
While State Department chatter about TIP issues did influence the decision to include a country in the TIP report (assuming the math is right), it doesn't seem that US engagement in TIP advocacy has an effect on a country's decision to criminalize human trafficking, either measured with observed Wikileaks cables (z = 1.2, p = 0.23) or estimated cables (z = -1.46, p = 0.144). 

The presence of more human trafficking NGOs does appear to influence the decision to criminalize though—for each additional NGO with headquarters in a country, the chance that that country will criminalize trafficking increases by 2% (z = 3.37, p < 0.001). 
...
* Replicate duration models from chapter and add new variables
* Check this claim in the "Who cares" section: "Statistical modeling (see Appendix X) that accounts for other factors (similar to the above models) also shows that the relationship between being included in the report and time to criminalization depends on the level of democracy. The models reinforce that the relationship between inclusion in the report and time to criminalization appears to be stronger for less democratic countries. TRUE? No?"
* Do this with both polity and UDS
