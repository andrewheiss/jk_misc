...
## Determinants of having a media reaction
...
extra.lines <- list(c("Year fixed effects", rep("No", 5)),
                    c("Country fixed effects", rep("No", 5)))
...
stargazer(model.reaction1, model.reaction2, model.reaction3, 
          ...
          dep.var.caption="Reaction in media (original models)", model.numbers=FALSE,
          type="html", omit="\\.factor",
          notes.align="l", add.lines=extra.lines,
...
stargazer(model.react.new1, model.react.new2, model.react.new3,
          ...
          apply.coef=exp, covariate.labels=var.labs, column.labels=col.labs, 
          model.numbers=FALSE, dep.var.labels.include=FALSE,
          dep.var.caption="Reaction in media (expanded models)", type="html",
