...
```{r, echo=FALSE, fig.width=4.5, fig.height=3, warning=FALSE}
...
stargazer(model.reaction1, model.reaction2, model.reaction3, 
          ...
          type="html", omit="\\.factor", keep.stat=c("n", "ll"), 
          notes.align="l", add.lines=extra.lines, se=ses,
          notes=c("Logit models; odds ratios reported. Non-robust standard errors in parentheses."))
```
...
stargazer(model.react.new1, model.react.new2, model.react.new3,
          ...
          covariate.labels=var.labs, column.labels=col.labs, 
          model.numbers=FALSE, dep.var.labels.include=FALSE,
          dep.var.caption="Reaction in cables (expanded models)", type="html",
          keep.stat=c("n", "ll"), omit="\\.factor",
          notes.align="l", add.lines=extra.lines, se=ses,
          notes=c("Logit model; odds ratios reported. Non-robust standard errors in parentheses. With the exception of tier ratings, all explanatory variables are lagged one period."))
```
